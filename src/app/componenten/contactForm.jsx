...
const ContactFormulier = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_5l1g4gm', 'template_k2szmvd', form.current, 'xbQW8YLhqV92u_RPh')
            .then((result) => {
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-4">
                            <li className="flex items-center">
                                ...
                                <a href="mailto:Lucas.Katamadze@hotmail.com" className="text-[#007bff] text-sm ml-4">
                                    <small className="block">Mail</small>
                                    <strong>Lucas.Katamadze@hotmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
